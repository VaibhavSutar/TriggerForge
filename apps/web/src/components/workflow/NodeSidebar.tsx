...
export const NodeSidebar: React.FC<NodeSidebarProps> = ({ isOpen, onClose, onAddNode }) => {
            ...
            {filteredNodes.map((nodeType, index) => (
              ...
              >
                <button
                  ...
                  className="w-full p-4 text-left border border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 hover:shadow-md transition-all duration-200 transform hover:scale-[1.02] group"
                >
