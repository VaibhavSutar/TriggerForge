...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
    ...
    },
    {
        ...
        nodes: [
            ...
            { id: "3", connectorId: "ai", label: "Extract Leads (JSON)", position: { x: 100, y: 400 }, config: { model: "gemini-2.0-flash", prompt: "Extract business leads from these search results: {{ $node.2.output.organic_results }}. Return a JSON array with 'name', 'website', and 'niche'." } },
